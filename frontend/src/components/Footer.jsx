          ...
          <div className="relative rounded-3xl bg-gradient-to-r from-[#FFFDD0] to-[#F9F4B9] text-white shadow-[0_20px_60px_rgba(124,58,237,0.25)] overflow-hidden">
            <div className="p-6 md:p-10">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
                ...
                <div className="max-w-3xl">
                  <div className="flex items-center gap-3 mb-4">
                    <img
                      src={logo}
                      alt="BengalFusion logo"
                      className="w-10 h-10 rounded-md bg-white/80 p-1"
                    />
                    <span className="text-3xl md:text-4xl font-semibold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent">
                      BengalFusion
                    </span>
                  </div>
                  <p className="text-xl md:text-xl bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent">
                    Bengal Fusion is your gateway to understanding the harmony
                    of heritage and modernity
                    <br />
                    that defines Bengal by discovering tourist places, foods,
                    festivals, culture, music,
                    <br /> and history with engaging visuals and concise
                    information.
                  </p>
              ...
              <div className="mt-8 border-t border-white/40 pt-6 flex flex-col md:flex-row items-center md:items-start justify-between gap-3 ">
                <p className="text-xl md:text-xl bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent">
                  © {year} BengalFusion. All rights reserved.
                </p>
